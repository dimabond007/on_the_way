            ...
            rides.forEach((ride) => {
                ...
                rideElement.innerHTML = `
                    <div class="ride-details">
                        ...
                        <p><strong>Trunk Available:</strong> ${ride.is_trunk ? "Yes" : "No"
                    }</p>
                        <p><strong>Date of Ride:</strong> ${ride.date_of_ride
                    }</p>
                        <p><strong>Time of Ride:</strong> ${ride.time_of_ride
                    }</p>
                        <button class="takeRideButton" data-ride-id="${ride.id
                    }">Take Ride</button>
                    </div>
                `;
